...
import { MultiSelectOptions, MultiSelectOption } from "./MultiSelectOptions";
import { MultiSelectGroups, MultiSelectOptionGroups } from "./MultiSelectOptionGroups";
                    ...
                    {filteredOptions instanceof MultiSelectOptionGroups ? (
                        filteredOptions.getOptionGroups().length > 0 ? (
                            filteredOptions.getOptionGroups().map(group => (
                                <Grid item xs={4} key={group.label}>
